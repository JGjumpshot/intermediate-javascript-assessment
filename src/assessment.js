...
// Which functions access the badjoke variable and get "Har" (Delete wrong answers, leave correct ones)
...
function Chimichanga() {
  this.percentLeft = 100;
  Function.prototype.eat = function(context) {
    this.percentLeft -= 20;
  }
...
function subway(personName) {
  return function(addIngredient) {
    var foodArray = []
    return {
      orderPerson: this.personName = personName,
      ingredients: this.ingredients = foodArray.push(addIngredient)
    }
  }
}
...
function typeCheck(param1, param2) {
  if(typeof param1 === typeof param2 && param1.valueOf() === param2.valueOf()) {
    return "Exact match";
  }
